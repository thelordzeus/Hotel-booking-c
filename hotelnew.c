/*
This porgram is made for the submission of mini-project on the topic of file handelling 
...
//structure defined to store name, room, breakFast and wifi required
struct hotel
{
    char name[20];
    char room[20];
...
int main()
{
    ...
    case 1: //ADMIN ENTRY SELECTED
    {
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            {
                printf("\n\nAccess granted!\n");
                fclose(passw); // this function closes the specified file
                break;
            }
            else
            {
...
void enter_name()
{
    ...
    fclose(enter);
    fclose(tmp1);
    remove("bookings.txt"); // this removes the mentioned file
...
//method defined to find guest name
void find_name()
{
    char buffer[20];
